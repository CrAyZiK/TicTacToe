...
import ru.unidubna.vsa.common.ITicTacToeProperty;
...
import ru.unidubna.vsa.view.reader.ConsoleCoordinateReader;

import java.util.InputMismatchException;

public class ConsoleView {
    private static final Character separator = ITicTacToeProperty.getDefaultProperties().getSeparatorCharacter();
